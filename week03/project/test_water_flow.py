...
# Test pressure_gain_from_water_height
...
# Test pressure_loss_from_pipe_reduction
...
# Test kPa → psi conversion
def test_convert_kpa_to_psi():
    assert convert_kpa_to_psi(0) == approx(0.0, abs=0.001)
    assert convert_kpa_to_psi(158.7) == approx(23.03, abs=0.01)
